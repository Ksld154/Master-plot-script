...
## new lenet e=50
RESULT_CSV_1 = './02-single_model/lenet/results_lenet_e=50_pre=0.1_window=5_staticTrue_gfTrue.csv'
RESULT_CSV_2 = './02-single_model/lenet/results_lenet_e=50_pre=0.25_window=5_staticTrue_gfTrue.csv'
METRIC_CSV_1 = './02-single_model/lenet/metrics_lenet_e=50_pre=0.1_window=5_staticTrue_gfTrue.csv'
METRIC_CSV_2 = './02-single_model/lenet/metrics_lenet_e=50_pre=0.25_window=5_staticTrue_gfTrue.csv'
...
def setup_folders(model_type):
    ...
    results_dir = os.path.join(base_dir, './02-single_model/lenet-result', f'{dt_string}_{model_type}')
