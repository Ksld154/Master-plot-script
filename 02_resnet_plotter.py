...
## new resnet e==100
RESULT_CSV_1 = './02-single_model/resnet/results_resnet_e=100_pre=0.1_window=5_staticTrue_gfTrue.csv'
RESULT_CSV_2 = './02-single_model/resnet/results_resnet_e=100_pre=0.25_window=5_staticTrue_gfTrue.csv'
METRIC_CSV_1 = './02-single_model/resnet/metrics_resnet_e=100_pre=0.1_window=5_staticTrue_gfTrue.csv'
METRIC_CSV_2 = './02-single_model/resnet/metrics_resnet_e=100_pre=0.25_window=5_staticTrue_gfTrue.csv'

def setup_folders(model_type):
    base_dir = os.path.dirname(__file__)
    now = datetime.datetime.now()
    dt_string = now.strftime("%m-%d-%Y_%H%M%S")
    results_dir = os.path.join(base_dir, './02-single_model/resnet-result', f'{dt_string}_{model_type}')
